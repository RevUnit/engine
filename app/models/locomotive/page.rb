module Locomotive
  class Page
    ...
    MINIMAL_ATTRIBUTES = %w(_id title slug fullpath position depth published templatized redirect listed response_type authentication_required parent_id parent_ids site_id created_at updated_at)
